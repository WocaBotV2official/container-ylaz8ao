...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ylaz8ao.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ylaz8ao.containers.anotherwebservice.com/
...
```
git clone git@github.com:WocaBotV2official/container-ylaz8ao.git
cd container-ylaz8ao
```
...
```
docker attach container-ylaz8ao
```
